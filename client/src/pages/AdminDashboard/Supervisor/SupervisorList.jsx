...
const SupervisorList = () => {
  ...
  const fetchUser = async () => {
    try {
      const response = await adminRequest.get(`${BASE_URL}/supervisor/list`);
      ...
      <main className="flex-1 flex flex-col overflow-hidden p-6">
        ...
        <div className="bg-white rounded-2xl shadow p-6 overflow-auto">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl font-semibold">Supervisor List</h2>
            <Link to="/create-supervisor">
