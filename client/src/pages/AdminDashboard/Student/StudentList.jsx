...
const StudentList = () => {
  ...
  const fetchUser = async () => {
    try {
      const response = await adminRequest.get(`${BASE_URL}/student/list`);
          ...
          <table className="w-full table-auto border-collapse">
            <thead>
              <tr className="bg-gray-200 text-left">
                <th className="p-3 text-sm font-semibold">Student ID</th>
            ...
            <tbody>
              {rows.length > 0 ? (
                rows.map((user) => (
                  ...
                  >
                    <td className="p-3 text-sm">{user.studentId}</td>
                    <td className="p-3 text-sm">{user.fullName}</td>
                    <td className="p-3 text-sm">{user.email}</td>
                    <td className="p-3 text-sm">{user.mobileNumber}</td>
