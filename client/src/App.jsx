...
import AsLogin from "./pages/AsPage/AsLogin";
    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/student-settingprofile" element={<StudentSettingProfile/>} />
          <Route path="/student-settingaccount" element={<StudentSettingAccount/>} />

          <Route path="/as-dashboard" element={<AsDashboard />} />
          <Route path="/as-Login" element={<AsLogin />} />
          ...
          <Route path="/client-settingprofile" element={<ClientSettingProfile />} />
          <Route path="/client-settingaccount" element={<ClientSettingAccount />} />
